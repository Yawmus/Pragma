...
public class Tile{
	...
	*/
	...
	public static Tile WALL = new Tile("test.png", "Wall", new boolean[]{true, false, false, false, false, false, false});
	...
	public Tile(String filename, String name, boolean[] properties){
		texture = new Texture(Gdx.files.internal("map/" + filename));
		tint = new Color();
		item = null;
		this.name = name;
