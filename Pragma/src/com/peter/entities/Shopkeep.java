...
public class Shopkeep extends NPC implements InputProcessor{
        ...
        public Shopkeep(int level, String race, String type, String name) {
            super("S.png", level, race, type, name);
        ...
        public void display(BitmapFont font, Vector2 screenCoord){
                ...
                if(hover != null){
                        Global.screen.begin();
                        Global.screen.draw(hover.getTexture(), ORIGIN_X + 205, ORIGIN_Y + 100);
                        font.draw(Global.screen, hover.getName(), ORIGIN_X + 245, ORIGIN_Y + 120);
                        font.draw(Global.screen, "Value: " + hover.getValue(), ORIGIN_X + 190, ORIGIN_Y + 80);
                        font.draw(Global.screen, "Weight: " + hover.getWeight(), ORIGIN_X + 255, ORIGIN_Y + 80);
            			font.draw(Global.screen, "1 - buy", ORIGIN_X + 196, ORIGIN_Y + 50);
