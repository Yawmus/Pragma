...
public class Gear{
	...
	public void draw(SpriteBatch spriteBatch) {
		spriteBatch.draw(items[0] != null ? items[0].getTexture() : unused[0], originX + 80, originY + 155);
		spriteBatch.draw(items[1] != null ? items[1].getTexture() : unused[1], originX + 80, originY + 115);
		spriteBatch.draw(items[2] != null ? items[2].getTexture() : unused[2], originX + 40, originY + 115);
		spriteBatch.draw(items[3] != null ? items[3].getTexture() : unused[3], originX + 80, originY + 75);
		spriteBatch.draw(items[4] != null ? items[4].getTexture() : unused[4], originX + 80, originY + 35);
		spriteBatch.draw(items[5] != null ? items[5].getTexture() : unused[5], originX + 120, originY + 115);
		spriteBatch.draw(items[6] != null ? items[6].getTexture() : unused[6], originX + 40, originY + 155);
	}
