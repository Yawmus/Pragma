...
public class Tile{
	...
	*/
	...
	public static final Tile DOOR = new Tile("slash.png", "slash2.png", new boolean[]{false, false, true, false, false});
	public static final Tile WATER = new Tile("w.png", "w2.png", new boolean[]{true, false, false, false, true});
	public static final Tile DOWN = new Tile("greater.png", "greater2.png", new boolean[]{false, true, false, false, true});
	public static final Tile UP = new Tile("less.png", "less2.png", new boolean[]{false, true, false, true, true});
