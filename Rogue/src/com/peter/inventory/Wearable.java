...
public class Wearable extends Item{
	public static Wearable HELMET = new Wearable("Helmet", 5, 17, "^.png", "Head", 3, '^');
	...
	public Wearable(String name, int weight, int value, String filename, String type, int defense, char symbol) {
