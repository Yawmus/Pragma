...
public class Tile{
	...
	*/
	...
	public static final Tile BLANK = new Tile("blank.png", new boolean[]{true, false, false});
	...
	public static final Tile DOOR = new Tile("slash.png", new boolean[]{false, false, false});
